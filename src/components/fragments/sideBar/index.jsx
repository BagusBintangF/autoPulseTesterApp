...
const SideBar = () => {
  return (
    <>
        <div className="relative flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-full w-full max-w-[16rem] p-4 shadow-xl shadow-blue-gray-900/5">
        <div className="mb-2 p-4">
            <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">autoPulse Electronics Tester</h5>
        </div>
