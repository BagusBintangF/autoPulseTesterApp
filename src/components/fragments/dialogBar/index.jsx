...
const DialogBar = (props) => {
  return (
    <div key={props.contentId} className="relative xl:w-[30rem] w-full xl:h-[15rem] h-[13rem] m-6 rounded bg-white text-gray-700 p-5 shadow-xl shadow-blue-gray-900/5">
